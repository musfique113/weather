...
const Color themeColor = Color(0xFF335AC7);
const Color secondaryColor = Color(0xFF335AC7);
const Color surface = Color(0xFF335AC7);
const Color white = Color(0xFFFFFFFF);
const Color black = Colors.black87;
const Color darkGray = Color(0xFFAFAFAF);
